...
@InputType()
class MeasurementCreateNestedManyWithoutTestTypesInput {
...
export { MeasurementCreateNestedManyWithoutTestTypesInput as MeasurementCreateNestedManyWithoutTestTypesInput };
