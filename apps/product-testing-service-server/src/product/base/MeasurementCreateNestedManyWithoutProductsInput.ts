...
@InputType()
class MeasurementCreateNestedManyWithoutProductsInput {
...
export { MeasurementCreateNestedManyWithoutProductsInput as MeasurementCreateNestedManyWithoutProductsInput };
